...
//        musicService.playsong(mSong);
        ...
        mApp.getPlayBackStarter().playSong(mSong);
    }
    ...
    public void playSong(Song song) {
       ...
       /* If getService returns null that means service has not started and we need to start and wait for it to start
        ...
        if (mApp.getService() == null) {
            Log.d("DEEPKA", "This is being called for the first time after clicking on the song as service is null, this should only be call once in the entire lifetime of the app.");
            ...
            Log.d("DEEPKA", "Now the service has started only this block will execute everytime you click on a song.");
            ...
            mApp.getService().playSong(mSong);
        }
    }
